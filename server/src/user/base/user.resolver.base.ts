...
export class UserResolverBase {
  ...
  async city(@graphql.Parent() parent: User): Promise<City | null> {
  ...
  async country(@graphql.Parent() parent: User): Promise<Country | null> {
  ...
  async state(@graphql.Parent() parent: User): Promise<State | null> {
